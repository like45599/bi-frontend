...
import { getChartByIdUsingGET } from '@/services/yubi/chartController';
    ...
    <div className="view-chart-data">
      <Row gutter={24}>
        <Col span={12}>
          ...
          <Card>
            <div style={{ whiteSpace: 'pre-wrap', overflow: 'auto' }}>
              <p style={{ fontWeight: 'bold', color: '#000000 ', textAlign: 'center' }}>
                {chart?.chartData}
              </p>
            </div>
        ...
        <Col span={12}>
          ...
          <Card>
            <div style={{ whiteSpace: 'pre-wrap', overflow: 'auto' }}>
              <p style={{ fontWeight: 'bold', color: '#000000', textAlign: 'left' }}>
