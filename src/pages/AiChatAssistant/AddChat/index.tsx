import { aiAssistantUsingPOST } from '@/services/yubi/aiAssitantController';
  ...
  return (
    <div className="add-chart">
      <Row gutter={24}>
        <Col span={24}>
          <Card>
            <Divider style={{fontWeight: 'bold', color: 'blue'}}>AI 问答助手</Divider>
            <Form
              form={form}
              name="addChat"
              labelCol={{span: 4}}
        ...
        <Col span={24}>
          <Card title={<div style={{ textAlign: 'center' ,color:'darkblue' }}>分析结论</div>}>
            <div style={{ marginBottom: '16px' }}>
              {questionResult ? (
                <ReactMarkdown components={components}>{questionResult}</ReactMarkdown>
